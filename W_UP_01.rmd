...
The question is there a difference between the average number of push ups that can be done in two minutes between skilled and line players. The data came from George Town College in Kentucky.
...
Push ups in a numerical variable, position is catagorical therefore we use numerical- cat file
# Results
...
P value is less than 0.05 so we reject the null hypothosis and conclude there is a difference between the amount of push ups a line player and skill player can do in 2 minutes
